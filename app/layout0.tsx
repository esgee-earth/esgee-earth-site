...
export const metadata: Metadata = {
  title: "ESGee Earth – Practical ESG & Carbon Clarity for Southeast Asia",
  description:
    "ESGee Earth helps Southeast Asian SMEs and supply-chain partners organise ESG and carbon data, aligned with GHG Protocol, IFRS S2, and local guidance like Bursa SEDG.",
};
          ...
          <header className="border-b border-slate-200 bg-white/80 backdrop-blur">
            <div className="mx-auto max-w-5xl px-4 py-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="h-8 w-8 rounded-full bg-emerald-700/90 flex items-center justify-center text-white text-xs font-semibold">
                  EE
                </div>
          ...
          <footer className="border-t border-slate-200 bg-white">
            <div className="mx-auto max-w-5xl px-4 py-6 text-xs text-slate-500 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex flex-wrap gap-3">
                <span>
                  Aligned with: GHG Protocol, IFRS S2 climate disclosures,
                  Bursa Malaysia SEDG guidance.
                </span>
              </div>
            </div>
          </footer>
